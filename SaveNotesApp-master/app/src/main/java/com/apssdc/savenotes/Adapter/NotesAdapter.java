package com.apssdc.savenotes.Adapter;
...
import com.apssdc.savenotes.Activity.UpdateNotesActivity;
import com.apssdc.savenotes.MainActivity;
    ...
    public void onBindViewHolder( NotesAdapter.notesViewholder holder, int position) {
        ...
        switch (note.notesPriority) {
            ...
            case "3":
                ...
                break;
            case "4":
                holder.notesPriority.setBackgroundResource(R.drawable.pink_shape);
                break;
        }
